...
<head>
    ...
    <style>
      ...
      .gnb li a {
        ...
        height: 70px;
        font-size: var(--f-H3);
        color: var(--c-menu-font);
        padding-left: 30px;
      }
      .gnb li a:hover {
        font-size: var(--f-H3);
        color: var(--c-menu-font-hover);
      }
      .gnb li a span + span {
        margin-left: 10px;
      }
...
<section class="course_view">
  ...
  <div class="course_list shadow_box">
    <div class="d-flex">
      ...
      <img src="" alt="강의 썸네일 이미지" class="border">
      <div class="course_info">
        ...
        <div>
          ...
          <span class="price main_stt number"></span>
          <span>원</span>
        </div>
      </div>
    </div>
    <div class="course_status d-flex justify-content-between">
      <div class="d-flex flex-column align-items-end status_wrap">
        <span class="price_btn_wrap mb-3">
          ...
          <a href="" class="del_btn btn btn-danger btn_g">삭제</a>
        </span>
      </div>
    </div>
      ...
      <div class="youtube_link">
          ...
          <div class="youtube_con d-flex gap-3 justify-content-center">
            ...
            <div class="youtubeViewurl">
              <a href="" target="blank" class="btn btn-outline-secondary">강의영상 바로가기</a>
            </div>
          </div>
