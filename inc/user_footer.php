        ...
        <div class="d-flex justify-content-between align-items-end">
          <div class="d-flex align-items-center">
            ...
            <div class="f_tt d-flex flex-column">
              <p>(주) Hello World 대표<span> SUDO</span></p>
              <div class="tel_mail d-flex">
                <p><span>대표번호</span>02-6666-6666</p>
                <p><span>사업자 번호</span>123-456-78910</p>
                <p><span>이메일</span>helloworld@helloworld.com</p>
              </div>
              <p><span>주소</span>서울특별시 종로구 100-100 (주) helloworld</p>
              <p>Copyright ⓒ 2023 HelloWorld Company. All Rights Reserved.</p>
            </div>
          </div>
          <div class="sns">
            <ul class="d-flex">
