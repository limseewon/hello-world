...
session_start();
$rest_api_key = "";       
$redirect_uri = "/helloworld/user/login/kakao_oauth.php";  // Redirect URI
$code = $_GET['code'];
...
$existing_user_query = "SELECT userid FROM members WHERE userid = '$userid'";
...
if ($existing_user_result->num_rows > 0) {
    ...
    $insert_query = "INSERT INTO members (userid, username, userimg) VALUES ('$userid', '$username','$userimg')";
