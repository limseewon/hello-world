...
<form action="qna_write_ok.php" method="POST">
   <div class="regist">
       <div class="mb-3 d-flex title">
           ...
           <input type="text" class="form-control title-box" name="title" id="title" placeholder="제목을 입력하시오."
                  required>
           <label for="formGroupExampleInput">이름</label>
           <input type="text" class="form-control name-box" name="name" id="name" placeholder="이름을 입력하시오."
                  required>
       </div>
       ...
       <div class="input-group d-flex file">
           <div class="add d-flex">
               ...
               <table class="table_1">
                   ...
                   <tr id="optionTr1">
                       <td>
                           <input type="file" class="form-control file-box" id="inputGroupFile04 file"
