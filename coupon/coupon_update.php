...
<body>
    ...
    ?>
        ...
        <form action="coupon_update_ok.php?cpid=" class="coupon_create_form" method="POST" enctype="multipart/form-data">
              ...
              <div class="info_bottom d-flex">
                <div class="field coupon_min_price input-group d-flex align-items-center">
                  ...
                  <input type="number" name="cp_limit" id="coupon_limit" class="form-control number"
                    placeholder="10,000" min="10000" max="1000000" step="1000" value="" required>원
                </div>
              ...
              <div class="field coupon_status">
                ...
                <div class="coupon_status_check d-flex">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="cp_status" id="coupon_status_1" value="1" >
          ...
          <fieldset class="coupon_option d-flex">
            ...
            <div class="coupon_sale">
              ...
              <div class="coupon_sale_check">
                <div class="form-check d-flex align-items-center">
                  <input class="form-check-input number" type="radio" name="cp_type" id="coupon_sale_1" value="정액" >
                  ...
                  placeholder="1,000" min="1000" max="1000000" step="1000" value="">원
                </div>
                <div class="form-check d-flex align-items-center">
                  ...
                  placeholder="10" min="5" max="100" step="5" value="">%
                </div>
                <div class="form-check d-flex align-items-center">
                  <input class="form-check-input" type="radio" name="cp_type" id="coupon_sale_0" value="정률">
            ...
            <div class="coupon_limit_date">
              ...
              <div class="coupon_limit_date_check">
                <div class="form-check d-flex align-items-center">
                  <input class="form-check-input" type="radio" name="cp_date_type" id="coupon_limit_date_1" >
