...
(4, 'admin', 'admin@helloworld.com', 'HelloWorld', '33275a8aa48ea918bd53a9181aa975f15ab0d0645398f5918a006d08675c1cb27d5c645dbd084eee56e675e25ba4019f2ecea37ca9e2995b49fcb12c096a032e', '2024-04-08 14:59:11', 100, '2024-05-18 23:05:01', NULL);
...
(4, 159, 'green', '2024-05-18 22:50:56'),
(5, 157, 'green', '2024-05-18 23:32:29'),
(7, 25, 'green', '2024-05-19 20:22:53');
...
(5, 'green', 'd', '홍길동16', '33275a8aa48ea918bd53a9181aa975f15ab0d0645398f5918a006d08675c1cb27d5c645dbd084eee56e675e25ba4019f2ecea37ca9e2995b49fcb12c096a032e', '2024-05-19', '010-2222-2222', 0, NULL, '2024-04-24'),
...
(276, '161', 5, NULL, NULL, NULL, NULL, NULL),
(277, '159', 5, 0, 4, '2024-05-19', '2857-08-18', '0');
...
(117, 0, '이광수', '컴파일러 구조가 어렵습니다', '컴파일러', 6, '답변', '2024-05-30 00:00:00', '컴파일러 수업에서 컴파일러의 구조와 동작 원리에 대해 배웠는데 이해가 잘 안됩니다. lexical analysis, syntax analysis, semantic analysis, code generation 등의 과정에 대해 좀 더 자세히 설명해 주시기 바랍니다.', '0', '', NULL),
...
(120, 145, '홍길동16', 'ㄴㅇㄴ', '만들고 비교하며 학습하는 리액트 (React)', 0, '미답변', '2024-05-17 10:39:03', '<p>ㅁㄴㅇㅁㄴㅇ</p>', '', 'green', NULL);
...
INSERT INTO `review` (`idx`, `cid`, `name`, `title`, `content`, `hit`, `view`, `date`, `rating`) VALUES
...
(6, 28, 'green', 1, '2024-08-18', '2024-05-18', '3개월 3000원 쿠폰');
...
--
ALTER TABLE `lecture`
  MODIFY `l_idx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=315;
...
--
ALTER TABLE `ordered_courses`
  MODIFY `ocid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=278;

--
-- 테이블의 AUTO_INCREMENT `qna`
--
ALTER TABLE `qna`
  MODIFY `idx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
